...
with open("INF_CAM.yaml", 'r', encoding='utf-8') as f:
...
raw_img_list = sorted(glob(f"{args['data_path']}/{args['camera']}/test/raw/*"))
srgb_img_list = sorted(glob(f"{args['data_path']}/{args['camera']}/test/sRGB/*"))

win_size = args['CAM_Dataset_size'][args['camera']]
