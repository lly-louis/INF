# Taken from https://github.com/SamsungLabs/content-aware-metadata/blob/main/data_generator.py
# The license for the original version of this file can be found in this directory.
...
def datagenerator(data_dir, batch_size=128, patch_size=48, stride=48, verbose=False, ftype='png'):
